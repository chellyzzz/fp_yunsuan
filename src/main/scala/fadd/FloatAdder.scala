...
class FloatAdderMixedFP16BF16() extends Module {
  ...
  val io = IO(new Bundle() {
    ...
    val frs1          = Input (UInt(16.W)) // VS1(63,0)
  ...
  val fp16_frs1_as_fp19 = Cat(io.frs1(15), fp16_frs1_as_fp19_exp_cvt, io.frs1(significandWidthFP16-2,0))
  ...
  val bf16_frs1_as_fp19 = Cat(io.frs1(15), io.frs1.tail(1).head(exponentWidthBF16), Cat(io.frs1(significandWidthBF16-2,0),0.U((significandWidthFP16 - significandWidthBF16).W)))
  ...
  val fp19_frs1 = MuxCase(0.U(19.W), Seq(
    is_bf16 -> bf16_frs1_as_fp19,
    is_fp16 -> fp16_frs1_as_fp19
  ))
  ...
  Mixed_Adder.io.fp_b := Mux(io.is_frs1, fp19_frs1, fp19_b)
